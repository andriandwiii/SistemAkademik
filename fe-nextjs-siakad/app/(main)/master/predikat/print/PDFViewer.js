...
export default function PDFViewerKKM({ pdfUrl, fileName = "Laporan_Master_KKM.pdf" }) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Toolbar */}
      <div className="flex justify-between items-center p-3 bg-gray-100 border-b shadow-sm">
